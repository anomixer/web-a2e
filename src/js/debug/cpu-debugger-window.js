...
export class CPUDebuggerWindow extends BaseWindow {
  ...
  toggleBreakpoint(addr) {
    console.log(
      "Toggle breakpoint at:",
      addr.toString(16),
      "exists:",
      this.breakpoints.has(addr),
    );
    if (this.breakpoints.has(addr)) {
    ...
    console.log(
      "Breakpoints now:",
      Array.from(this.breakpoints.keys()).map((a) => a.toString(16)),
    );
  }
