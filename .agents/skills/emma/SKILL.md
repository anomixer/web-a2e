...
**Task sets location**: `.Codex/docs/tasks/<name>/`
...
.Codex/docs/tasks/<name>/      # Development task sets (one folder per project)
...
- Context: "AGENTS.md", "README", "docs", "release notes", "bindings"
