...
This skill is located at: `.Codex/skills/mcp-client/`

**Script path:** `.Codex/skills/mcp-client/scripts/mcp_client.py`
...
**Your config file:** `.Codex/skills/mcp-client/references/mcp-config.json`
...
All commands use the script at `.Codex/skills/mcp-client/scripts/mcp_client.py`:

```bash
# List configured servers
python .Codex/skills/mcp-client/scripts/mcp_client.py servers

# List tools from a server
python .Codex/skills/mcp-client/scripts/mcp_client.py tools <server_name>

# Call a tool
python .Codex/skills/mcp-client/scripts/mcp_client.py call <server> <tool> '{"arg": "value"}'
```
...
# 2. List Zapier tools
python .Codex/skills/mcp-client/scripts/mcp_client.py tools zapier

# 3. Call a Zapier tool
python .Codex/skills/mcp-client/scripts/mcp_client.py call zapier <tool_name> '{"param": "value"}'
```
...
```bash
# 1. List tools
python .Codex/skills/mcp-client/scripts/mcp_client.py tools sequential-thinking

# 2. Use sequential thinking
python .Codex/skills/mcp-client/scripts/mcp_client.py call sequential-thinking sequentialthinking '{"thought": "Breaking down the problem...", "thoughtNumber": 1, "totalThoughts": 5, "nextThoughtNeeded": true}'
```
